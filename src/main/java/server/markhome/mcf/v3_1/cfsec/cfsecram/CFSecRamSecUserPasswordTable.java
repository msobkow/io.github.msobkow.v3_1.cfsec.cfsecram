	...
	implements ICFSecSecUserPasswordTable
{
		...
		ICFSecSecUserPassword iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecUserPassword > subdictSetStampIdx;
		if( dictBySetStampIdx.containsKey( keySetStampIdx ) ) {
			subdictSetStampIdx = dictBySetStampIdx.get( keySetStampIdx );
		}
		else {
			subdictSetStampIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecUserPassword >();
		...
		LocalDateTime PWSetStamp )
	{
		...
		if( dictBySetStampIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffSecUserPassword > subdictSetStampIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecUserPassword >();
		...
		ICFSecSecUserPassword iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecUserPassword > subdict;
		...
		if( dictBySetStampIdx.containsKey( newKeySetStampIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecUserPassword >();
