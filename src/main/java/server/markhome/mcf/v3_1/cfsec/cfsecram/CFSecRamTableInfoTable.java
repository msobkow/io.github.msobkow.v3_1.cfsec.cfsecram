	...
	implements ICFSecTableInfoTable
{
		...
		String SuperName )
	{
		...
		if( dictBySuperNameIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffTableInfo > subdictSuperNameIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffTableInfo >();
		...
		ICFSecTableInfo iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffTableInfo > subdict;
		...
		if( dictBySuperNameIdx.containsKey( newKeySuperNameIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffTableInfo >();
