	...
	implements ICFSecSecUserTable
{
		...
		ICFSecSecUser iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecUser > subdictEMAddrIdx;
		if( dictByEMAddrIdx.containsKey( keyEMAddrIdx ) ) {
			subdictEMAddrIdx = dictByEMAddrIdx.get( keyEMAddrIdx );
		}
		else {
			subdictEMAddrIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecUser >();
		...
		String EMailAddress )
	{
		...
		if( dictByEMAddrIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffSecUser > subdictEMAddrIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecUser >();
		...
		ICFSecSecUser iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecUser > subdict;
		...
		if( dictByEMAddrIdx.containsKey( newKeyEMAddrIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecUser >();
