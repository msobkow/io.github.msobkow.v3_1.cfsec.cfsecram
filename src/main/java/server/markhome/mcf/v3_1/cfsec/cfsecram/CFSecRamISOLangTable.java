	...
	implements ICFSecISOLangTable
{
		...
		ICFSecISOLang iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffISOLang > subdictCode2Idx;
		if( dictByCode2Idx.containsKey( keyCode2Idx ) ) {
			subdictCode2Idx = dictByCode2Idx.get( keyCode2Idx );
		}
		else {
			subdictCode2Idx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffISOLang >();
		...
		String ISO6391Code )
	{
		...
		if( dictByCode2Idx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffISOLang > subdictCode2Idx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffISOLang >();
		...
		ICFSecISOLang iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffISOLang > subdict;
		...
		if( dictByCode2Idx.containsKey( newKeyCode2Idx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffISOLang >();
