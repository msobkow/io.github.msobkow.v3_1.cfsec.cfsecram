	...
	implements ICFSecISOTZoneTable
{
		...
		ICFSecISOTZone iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffISOTZone > subdictOffsetIdx;
		if( dictByOffsetIdx.containsKey( keyOffsetIdx ) ) {
			subdictOffsetIdx = dictByOffsetIdx.get( keyOffsetIdx );
		}
		else {
			subdictOffsetIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffISOTZone >();
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffISOTZone > subdictIso8601Idx;
		if( dictByIso8601Idx.containsKey( keyIso8601Idx ) ) {
			subdictIso8601Idx = dictByIso8601Idx.get( keyIso8601Idx );
		}
		else {
			subdictIso8601Idx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffISOTZone >();
		...
		short TZMinOffset )
	{
		...
		if( dictByOffsetIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffISOTZone > subdictOffsetIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffISOTZone >();
		...
		ICFSecISOTZone iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffISOTZone > subdict;
		...
		if( dictByOffsetIdx.containsKey( newKeyOffsetIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffISOTZone >();
