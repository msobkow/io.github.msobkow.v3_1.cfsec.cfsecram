	...
	implements ICFSecSecUserEMConfTable
{
		...
		String ConfirmEMailAddr )
	{
		...
		if( dictByConfEMAddrIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffSecUserEMConf > subdictConfEMAddrIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecUserEMConf >();
		...
		ICFSecSecUserEMConf iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecUserEMConf > subdict;
		...
		if( dictByConfEMAddrIdx.containsKey( newKeyConfEMAddrIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecUserEMConf >();
