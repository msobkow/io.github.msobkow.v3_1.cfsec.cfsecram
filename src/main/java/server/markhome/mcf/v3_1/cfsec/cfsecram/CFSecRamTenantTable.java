	...
	implements ICFSecTenantTable
{
		...
		ICFSecTenant iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffTenant > subdictClusterIdx;
		if( dictByClusterIdx.containsKey( keyClusterIdx ) ) {
			subdictClusterIdx = dictByClusterIdx.get( keyClusterIdx );
		}
		else {
			subdictClusterIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffTenant >();
		...
		ICFLibKeyHash256 ClusterId )
	{
		...
		if( dictByClusterIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffTenant > subdictClusterIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffTenant >();
		...
		ICFSecTenant iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffTenant > subdict;
		...
		if( dictByClusterIdx.containsKey( newKeyClusterIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffTenant >();
