	...
	implements ICFSecSysClusterTable
{
		...
		ICFSecSysCluster iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSysCluster > subdictClusterIdx;
		if( dictByClusterIdx.containsKey( keyClusterIdx ) ) {
			subdictClusterIdx = dictByClusterIdx.get( keyClusterIdx );
		}
		else {
			subdictClusterIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSysCluster >();
		...
		ICFLibKeyHash256 ClusterId )
	{
		...
		if( dictByClusterIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffSysCluster > subdictClusterIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSysCluster >();
		...
		ICFSecSysCluster iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSysCluster > subdict;
		...
		if( dictByClusterIdx.containsKey( newKeyClusterIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSysCluster >();
