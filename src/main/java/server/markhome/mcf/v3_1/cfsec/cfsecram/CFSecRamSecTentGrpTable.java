	...
	implements ICFSecSecTentGrpTable
{
		...
		ICFSecSecTentGrp iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecTentGrp > subdictTenantIdx;
		if( dictByTenantIdx.containsKey( keyTenantIdx ) ) {
			subdictTenantIdx = dictByTenantIdx.get( keyTenantIdx );
		}
		else {
			subdictTenantIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecTentGrp >();
			dictByTenantIdx.put( keyTenantIdx, subdictTenantIdx );
		}
		subdictTenantIdx.put( pkey, Buff );

		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecTentGrp > subdictNameIdx;
		if( dictByNameIdx.containsKey( keyNameIdx ) ) {
			subdictNameIdx = dictByNameIdx.get( keyNameIdx );
		}
		else {
			subdictNameIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecTentGrp >();
		...
		ICFLibKeyHash256 TenantId )
	{
		...
		if( dictByTenantIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffSecTentGrp > subdictTenantIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecTentGrp >();
		...
		ICFSecSecTentGrp iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecTentGrp > subdict;
		...
		if( dictByTenantIdx.containsKey( newKeyTenantIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecTentGrp >();
