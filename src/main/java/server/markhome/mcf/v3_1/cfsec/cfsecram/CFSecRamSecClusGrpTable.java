	...
	implements ICFSecSecClusGrpTable
{
		...
		ICFSecSecClusGrp iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecClusGrp > subdictClusterIdx;
		if( dictByClusterIdx.containsKey( keyClusterIdx ) ) {
			subdictClusterIdx = dictByClusterIdx.get( keyClusterIdx );
		}
		else {
			subdictClusterIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecClusGrp >();
			dictByClusterIdx.put( keyClusterIdx, subdictClusterIdx );
		}
		subdictClusterIdx.put( pkey, Buff );

		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecClusGrp > subdictNameIdx;
		if( dictByNameIdx.containsKey( keyNameIdx ) ) {
			subdictNameIdx = dictByNameIdx.get( keyNameIdx );
		}
		else {
			subdictNameIdx = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecClusGrp >();
		...
		ICFLibKeyHash256 ClusterId )
	{
		...
		if( dictByClusterIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFSecBuffSecClusGrp > subdictClusterIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecClusGrp >();
		...
		ICFSecSecClusGrp iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFSecBuffSecClusGrp > subdict;
		...
		if( dictByClusterIdx.containsKey( newKeyClusterIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFSecBuffSecClusGrp >();
