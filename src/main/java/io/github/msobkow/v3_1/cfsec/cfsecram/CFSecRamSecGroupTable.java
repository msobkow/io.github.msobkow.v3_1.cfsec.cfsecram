	...
	implements ICFSecSecGroupTable
{
	...
	public CFSecBuffSecGroup ensureRec(ICFSecSecGroup rec) {
		if (rec == null) {
			...
			if (classCode == ICFSecSecGroup.CLASS_CODE) {
				return( ((CFSecBuffSecGroupDefaultFactory)(schema.getFactorySecGroup())).ensureRec((ICFSecSecGroup)rec) );
			}
			else {
	...
	public ICFSecSecGroup lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		final String S_ProcName = "CFSecRamSecGroup.lockDerived";
		ICFSecSecGroup buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFSecSecGroup readRec( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		final String S_ProcName = "CFSecRamSecGroup.readRec";
	...
	public ICFSecSecGroup readRecByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SecGroupId )
	{
		final String S_ProcName = "CFSecRamSecGroup.readRecByIdIdx() ";
